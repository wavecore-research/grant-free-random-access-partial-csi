...
X, Y = np.meshgrid(lambdas, snrs_dB)
surf = ax.plot_surface(X, Y, np.average(MSE_prior_csi, axis=0), label="prior CSI", alpha=0.4)
surf._facecolors2d = surf._facecolor3d
surf._edgecolors2d = surf._edgecolor3d
surf = ax.plot_surface(X, Y, np.average(MSE_partial_csi, axis=0), label="partial CSI", alpha=0.4)
surf._facecolors2d = surf._facecolor3d
surf._edgecolors2d = surf._edgecolor3d
surf = ax.plot_surface(X, Y, np.average(MSE_no_csi, axis=0), label="no CSI", alpha=0.4)
surf._facecolors2d = surf._facecolor3d
surf._edgecolors2d = surf._edgecolor3d
